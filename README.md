...
Named Entity Recognition (NER) is an important task in Natural Language Processing, where the goal is to identify and classify entities such as names of persons, locations, and organizations in text data. Traditional methods struggle to capture contextual and sequential relationships between words.

To address this, a deep learning model based on Long Short-Term Memory (LSTM) is developed to learn contextual dependencies in sequences. The model is trained on a labeled dataset to automatically recognize and classify named entities in text, and its performance is evaluated using suitable metrics.
...
<img width="943" height="724" alt="image" src="https://github.com/user-attachments/assets/805f9829-cd1d-4cb4-954f-fd3846fd2af2" />


### Sample Text Prediction

<img width="942" height="738" alt="image" src="https://github.com/user-attachments/assets/c3d7697d-f3bf-400f-bcf0-00e8bf1ae8e2" />
